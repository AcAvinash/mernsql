...
import { FaRegHeart, FaShareAlt, FaThList, FaTimes } from "react-icons/fa";
...
const Navbar: React.FC<NavbarProps> = ({ onSearch }) => {
    ...
    function shareOnWhatsApp() {
        const message = `http://localhost:3000?ref=${localStorage.getItem('userId')}`;
            ...
            <header className="fixed top-0 left-0 right-0 z-30 shadow-2xl">
                <nav className="bg-white lg:px-6 pt-2.5 md:pb-1.5">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        <a href="/" className=" md:ml-0 ml-4 relative flex items-center overflow-hidden">
                            <Image src={Logo2}
                                width={100}
                                height={100}
                                className="" alt='logo' />
                        ...
                        <a href="https://flowbite.com" className="flex items-center">
                            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-black">Labhkari</span>
                        </a> */}
                        <div className="flex items-center lg:order-2">
                            ...
                            {admin && (
                                <Link href={'/admin/product'} className="block text-black text-2xl md:mr-0 focus:ring-4 focus:outline-none focus:ring-[#103178] font-medium rounded-lg px-5 py-2.5 text-center">
                                    <RiAdminFill />
                                </Link>
                            )}
